...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>fdf
    	 <form action="${ctx}/teacher/addTeacher" id="teacherForm" method="get">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		    ...
		    <tr><td class="font3 fftd">
		    	<table>
                    ...
                    <tr>
		    			...
		    			<td class="font3 fftd">角&nbsp;色：<input type="text" name="role" id="role" size="20"/></td> 
		    		</tr>		    		
		    	</table>
		    </td></tr>
