...
<head>
	...
	<script type="text/javascript">
	       $(function(){
	    	   ...
	    	   /** 查重作业绑定点击事件 */
	    	   $("#doSimilarity").click(function(){
	    		   /** 获取到用户选中的复选框  */
	    		   var checkedBoxs = boxs.filter(":checked");
	    		   if(checkedBoxs.length < 1){
	    			   $.ligerDialog.error("请选择一个需要查重的作业！");
	    		   }else{
	    			   /** 得到用户选中的所有的需要删除的ids */
	    			   ...
	    			   var checkRate = $("#checkRate").attr("value");
	    			   $.ligerDialog.confirm("确认要查重吗?","查重作业",function(r){
	    				   if(r){
	    					   // alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${ctx }/correctWorkbook/runSimilarity?ids=" + ids.get()+"&checkRate="+checkRate;
	    				   }
	    			   });
	    		   }
	    	   })
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
			...
			<td height="20">
				<table width="100%" border="1" cellpadding="5" cellspacing="0"
					style="border: #c2c6cc 1px solid; border-collapse: collapse;">
					 <tr valign="top"  >
					    <td class="font3" colspan="9" >
						    查重的比率：<input type="text" id="checkRate" value="0.8">
					    	<input id="doSimilarity" type="button" value="查重"/>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/correctWorkbook/selectCorrectWorkbook?pageIndex={0}&isSimilarity=2"/>
	  </td></tr>
	</table>
