...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/workbook/exportToScoreExcel"  method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
					    ...
					    <td class="font3 fftd">学&nbsp;&nbsp;&nbsp;期：
		    			 <select name="term" style="width:143px;"  id="course">
			...
			<input type="submit" value="查询">&nbsp;&nbsp;<input type="reset" value="取消 " ></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
