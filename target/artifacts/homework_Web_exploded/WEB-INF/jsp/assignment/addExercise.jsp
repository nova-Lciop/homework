...
<head>
	...
	<script type="text/javascript">
	       $(function(){
	    	   ...
	    	   /** 添加习题到作业绑定点击事件 */
	    	   $("#addExerciseToAssignment").click(function(){
	    		   /** 获取到用户选中习题的复选框  */
	    		   var checkedBoxs = boxs.filter(":checked");
	    		   if(checkedBoxs.length < 1){
	    			   $.ligerDialog.error("请选择一个需要添加的习题！");
	    		   }else{
	    			   /** 得到用户选中的所有要添加的习题ids */
	    			   ...
	    			   $.ligerDialog.confirm("确认要添加吗?","添加习题",function(r){
	    				   if(r){
	    					   // alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${ctx }/assignment/addAssignment?workbook_id=${workbook_id}&&ids=" + ids.get();
	    				   }
	    			   });
	    		   }
	    	   })
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置： 布置作业1&gt;  添加习题</td>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  ...
			  <input type="hidden" name="exercise" value="${exercise}">
			  	<form name="exercixeform" method="post" id="exerciseform" action="${ctx}/assignment/selectExercise">
					...
					<select id="kind" name="kind" style="width:143px;">
						   ...
						   <option value="3">简答</option>
					    	...
					    	<input id="addExerciseToAssignment" type="button" value="添加习题到作业"/>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/assignment/selectExercise?pageIndex={0}&workbook_id=${workbook_id}&teacher_id=${teacher_id}&course_id=${course_id}&kind=${kind}&chapter=${chapter}" />
	  </td></tr>
	</table>
