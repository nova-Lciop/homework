	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${ctx}/workbook/selectWorkbook">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3" width="30%" >
					    	班级:
							    <select name="clazz.id" style="width:143px;">
					    		...
					    		<tr><td class="font3">
					    	学期：<select name="term" style="width:143px;">
					    	...
					    	<td class="font3">
					    	作业状态：<select name="wflag" style="width:143px;">
					    			<option value="">--请选择作业状态--</option>
					    				<option value="0">未发布</option>
					    				<option value="1">发布</option>
					    				<option value="2">批改</option>
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/workbook/selectWorkbook?pageIndex={0}"/>
	  </td></tr>
	</table>
