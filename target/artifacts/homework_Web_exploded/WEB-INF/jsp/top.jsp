...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
<%--    <td width="320" height="80" class="topbg"><img src="${ctx}/images/logo.png" width="320" height="80"></td>--%>
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  ...
		  <td height="30" class="topnavbg">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td class="topnavlh" align="left"><img src="${ctx}/images/StatBar_admin.gif">&nbsp;&nbsp;当前教师：【${sessionScope.teacher_session.username}】</td>
