...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：学生管理 &gt; 学生查询</td>
				    ...
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	...
					    	登录名：<input type="text" name="loginname" maxlength="18">
					    </td>
					  </tr>
					  <tr>
					    <td class="font3">
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${student.id}"></td>
					 ...
					 <!-- <td>${student.password }</td>-->
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/student/updateStudent?flag=1&id=${student.id}">
